...
public class DialogFactory {
   ...
   public static boolean displayConfirmationDialog(String text) {
      ...
      try {
         FXMLLoader loader = new FXMLLoader(DialogFactory.class.getResource(
               "../view/dialog/confirmationDialog.fxml"));
    ...
    * @return user response
    */
   public static Object displayEnumerationDialog(String text, Object[] enumerations) {
      final Response<Object> response = new Response<Object>(null);

      // Load resource, extract node and controller
      try {
         FXMLLoader loader = new FXMLLoader(DialogFactory.class.getResource(
               "../view/dialog/enumerationDialog.fxml"));
         Parent root = loader.load();
         EnumerationDialogController controller = loader.getController();
         controller.setText(text);
         controller.setEnumerations(enumerations);
         controller.setResponse(response);
   ...
   public static boolean displayTaskProgressDialog(String text, Task task) {
      ...
      try {
         FXMLLoader loader = new FXMLLoader(DialogFactory.class.getResource(
               "../view/dialog/taskProgressDialog.fxml"));
         Parent root = loader.load();
   ...
   public static Parameters displayParametersDialog(Parameters params) {
      ...
      try {
         FXMLLoader loader = new FXMLLoader(DialogFactory.class.getResource(
               "../view/dialog/parametersDialog.fxml"));
         Parent root = loader.load();
   ...
   public static Network displayNetworkDialog() {
      ...
      try {
         FXMLLoader loader = new FXMLLoader(DialogFactory.class.getResource(
               "../view/dialog/networkDialog.fxml"));
         Parent root = loader.load();
